...
ui <- fluidPage(
  ...
  div(class = "article-container",
      ...
      p("Suppose, now, that, in reference to any question, we have no other knowledge than that it belongs to a class of which a certain proportion ", em("r"), " have true answers. ",
        span(class = "example-trigger", id = "ex7-trigger",
