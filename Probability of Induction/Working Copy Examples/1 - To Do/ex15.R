...
ui <- fluidPage(
  ...
  div(class = "article-container",
      ...
      p("Hence the colors of the balls already drawn have no influence upon the probability of any color being drawn next, that is to say, the probabilities of the different drawings are independent. ",
