...
ui <- fluidPage(
  ...
  div(class = "article-container",
      ...
      p("Suppose we had an immense granary filled with black and white balls well mixed up; and suppose that we had two strangers, A and B, who were going to draw each a number of balls and show them to us. ",
        span(class = "example-trigger", id = "ex12-trigger",
