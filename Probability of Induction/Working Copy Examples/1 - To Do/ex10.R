...
ui <- fluidPage(
  ...
  div(class = "article-container",
      ...
      p("Suppose we have a large bag of beans from which one has been secretly drawn at random and hidden under a thimble. ",
        span(class = "example-trigger", id = "ex10-trigger",
